...
If the concept you need is not in the glossary yet, either you are inventing language the project does not use or there is a real gap. Reconsider the wording or note it for `/domain-modeling`.
